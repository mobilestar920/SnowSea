(function () {
  ...
  function routeConfig($stateProvider) {
    ...
    $stateProvider
      .state('home.option-settings', {
        url: 'option-settings/:state',
        templateUrl: '/modules/settings/client/views/option-settings.client.view.html',
        controller: 'OptionSettingsController',
        controllerAs: 'vm',
        data: {
          pageTitle: 'Basic Options'
        }
      })
      ...
      .state('home.rig-settings', {
        url: 'rig-settings/:state?miner&pool&wallet&mac&gpus&host',
