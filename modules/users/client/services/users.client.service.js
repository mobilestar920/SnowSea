(function () {
  ...
  function AdminService($resource) {
    var Admin = $resource('/api/users/:userId', { userId: '@_id' }, {
      update: {
        method: 'PUT'
      },
      updatePass: {
    ...
    angular.extend(Admin, {
      updatePassword: function (userId, passwordDetails) {
        return this.updatePass({ userId: userId }, passwordDetails).$promise;
      }
    });
