        ...
        vm.sidebar = [
          ...
          },
          {
            ...
            sub: [
              {
                name: 'Miner',
                state: 'home.option-settings({ state: "miner" })'
              },
              {
                name: 'Wallet',
                state: 'home.option-settings({ state: "wallet" })'
              },
              {
                name: 'Pool',
                state: 'home.option-settings({ state: "pool" })'
              }
            ]
          },
          {
            ...
            sub: [
              {
                name: 'New',
                state: 'home.add-users({ state: "all" })'
              },
              {
                name: 'All',
                state: 'home.manage-users({ state: "all" })'
              }
            ]
          },
          {
